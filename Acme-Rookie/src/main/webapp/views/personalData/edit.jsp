...
<form:form modelAttribute="personalData" action="personalData/rookie/save.do">
	<acme:hidden path="id"/>
	...
	<acme:cancel url="/curricula/rookie/display.do?curriculaId=${personalData.curricula.id}" code="personalData.edit.cancel" />
</form:form>