...
<div>
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('ROOKIE')">
			<li>
				<a class="fNiv" href="finder/rookie/edit.do"><spring:message code="master.page.finder.edit" /></a>
			</li>
			<li>
				<a class="fNiv" href="curricula/rookie/list.do"><spring:message code="master.page.curricula.list" /></a>
			</li>
			<li>
				<a class="fNiv" href="application/rookie/list.do"><spring:message code="master.page.list.application" /></a>
			</li>
		</security:authorize>
