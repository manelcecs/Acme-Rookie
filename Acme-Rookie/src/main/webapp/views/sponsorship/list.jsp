...
<acme:button url="sponsorship/provider/create.do" type="button" code="sponsorship.list.create"/>

	<jstl:if test="${empty sponsorships}">
		<p><spring:message code="sponsorship.list.empty"/></p>
	</jstl:if>

	<section id="displaySponsorships">

		<display:table pagesize="1" name="sponsorships" id="sponsorship" requestURI="${requestURI}">
