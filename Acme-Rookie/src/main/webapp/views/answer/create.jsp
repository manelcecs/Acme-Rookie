...
<acme:button code="answer.create.cancel" type="button" url="application/rookie/list.do"/>

<form:form modelAttribute="answer" action="answer/rookie/save.do" method="post">
