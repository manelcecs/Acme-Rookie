...
<security:authorize access="hasRole('ROOKIE')">
	<acme:button url="application/rookie/list.do" type="button" code="application.seeMore.back"/>
</security:authorize>
...
<security:authorize access="hasRole('ROOKIE')">
	<acme:button code="application.seeMore.curricula" type="button" url="curricula/rookie/display.do?curriculaId=${application.curricula.id}"/>
</security:authorize>
<security:authorize access="hasRole('COMPANY')">
