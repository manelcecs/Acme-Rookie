...
<form:form modelAttribute="miscellaneousData"
	action="miscellaneousData/rookie/save.do">
	<acme:hidden path="id" />
	...
	<acme:cancel url="/curricula/rookie/display.do?curriculaId=${miscellaneousData.curricula.id}" code="miscellaneousData.edit.cancel" />
</form:form>
<button class="addTag"
