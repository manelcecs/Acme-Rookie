...
public class FinderService {
	...
	public Finder save(final Finder finder) throws ParseException {
		...
		Assert.isTrue(this.rookieService.findByPrincipal(LoginService.getPrincipal()).getFinder().getId() == finder.getId());
	...
	public Finder reconstruct(final Finder finder, final BindingResult binding) {
		...
		final Finder result = this.finderRepository.findOne(this.rookieService.findByPrincipal(LoginService.getPrincipal()).getFinder().getId());
