...
public class PositionService {
	...
	public Collection<Position> getFilterPositionsByFinder(final String keyword, final Date minimumdeadline, final Date maximumDeadline, final Double minimumSalary) {
		Assert.isTrue(AuthorityMethods.chechAuthorityLogged("ROOKIE") || AuthorityMethods.chechAuthorityLogged("COMPANY"));
	...
	public Collection<Position> getPositionsCanBeApplied(final int idRookie) {
		return this.positionRepository.getPositionsCanBeApplied(idRookie);
	}
