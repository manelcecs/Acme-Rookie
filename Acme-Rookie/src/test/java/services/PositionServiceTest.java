	...
	public void newPositionsDriver() throws ParseException {
		...
		final Object testingData[][] = {
			...
			},
			{
				/*
				 * a) Crear una posicion estando registrado
				 * b) La compania registrada debe ser la que sea la autora de una nueva posicion
				 * c) 63%
				 * d) 17/17
				 */
			...
			},
			{
				/*
				 * a) Crear una posicion estando registrado
				 * b) Un rookie no puede crear una posicion
				 * c) 63%
				 * d) 17/17
				 */

				"rookie0", "titulo valido", "descripcion valida", this.format.parse("2020/01/01 11:00:00"), "Perfil valido", skills, technologies, 500.0, true, false, "company0", this.intermediaryBetweenTransactions.generateTicker("MSI"),
				IllegalArgumentException.class
			},
			{
				/*
		...
		final Object testingData[][] = {
			{
				...
				/*
				 * a) Cambiar el modo borrador estando registrado
				 * b) Una compania no puede cambiar el modo borrador de una position que no es la suya
				 * c) 100%
				 * d)
				 */
		...
		final Object testingData[][] = {
			{
				...
				/*
				 * a) Cambiar el atributo cancelado cuando esta registrado
				 * b) Una compania solo puede cambiar el atributo cancel de sus posiciones
				 * c) 100%
				 * d)
				 */
				...
				/*
				 * a) Cambiar el atributo cancelado cuando esta registrado
				 * b) No se puede cancelar una posicion que esten modo draft
				 * c) 100%
				 * d)
				 */
		...
		final Object testingData[][] = {
			{
				...
				/*
				 * a) Borrar la posicion si esta logueado
				 * b) Una compania solo puede borrar sus posiciones
				 * c) 100%
				 * d)
				 */
	...
	public void editTest() throws ParseException {
		...
		final Object testingData[][] = {
			...
			},
			{
				/*
				 * a) Una position es editada por un usuario logueado
				 * b) Una posicion no puede ser editada por una compania que no es la autora
				 * c) 100%
				 * d) 17/17
				 */
