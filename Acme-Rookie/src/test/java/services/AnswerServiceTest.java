		...
		final Object testingData[][] = {
			{
				 ...
				 * d) 6/6
				 */
				"rookie0", "explicacion valido", "http://www.url.com", "application0", null
			}, {
				/*
				 * a) Una respuesta es creada por un usuario logueado
				 * b) Un rookie no puede crear una respuesta a una aplicacion que no es la suya
				 * c) 100%
				 * d) 6/6
				 */

				"rookie1", "explicacion valido", "http://www.url.com", "application0", IllegalArgumentException.class
			}, {
				/*
				 * a) Una respuesta es creada por un usuario logueado
				 * b) Una compania no puede crear respuestas
				 * c) 100%
				 * d) 6/6
				 */
				 ...
				 * d) 6/6
				 */
				"rookie1", "explicacion valido", "url invalida", "application1", ConstraintViolationException.class
			}
		};
