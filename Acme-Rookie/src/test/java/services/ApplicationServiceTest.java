...
public class ApplicationServiceTest extends AbstractTest {
	...
	public void newApplicationDriver() throws ParseException {
		...
		final Object testingData[][] = {
			{
				/*
				 * a) Una aplicacion es creada por un usuario que esta logueado
				 * b) Positivo
				 * c) 100%
				 * d) 9/12
				 */
				"rookie0", "position00", "curricula00", null
			}, {
				/*
				 * a) Una aplicacion es creada por un usuario que esta logueado
				 * b) Una compania no puede crear aplicaciones
				 * c) 100%
				 * d) 9/12
				 */
				 ...
				 * d) 9/12
				 */
				"rookie0", "position31", "curricula00", IllegalArgumentException.class
			}, {
				/*
				 * a) Una aplicacion es creada por un usuario que esta logueado
				 * b) La curricual tiene que ser del rookie que crea la aplicacion
				 * c) 100%
				 * d) 9/12
				 */
				"rookie0", "position00", "curricula01", IllegalArgumentException.class
			}
		...
		final Object testingData[][] = {
			{
				 ...
				 * b) El estado tiene que ser ACEPTED O REJECTED
				 * c) 100%
				 * d) 3/12
				 */
				...
				/*
				 * a) El estado se puede cambiar si el usuario esta logueado
				 * b) Solo pueden cambiar el estado la compania propietaria de la posicion a la que hace referencia la application
				 * c) 100%
				 * d) 3/12
				 */
