...
public class AuditServiceTest extends AbstractTest {
	...
	/*
	 * Este test prueba la edición de una nueva auditoría
	 * 
	 * 1 positive,
	 * 6 negative
	 */
		...
		final Object testingData[][] = {
			{
				 ...
				 * d) 9/9
				 */
				"company0", true, 7, this.format.parse("2019/01/01 11:00:00"), "Texto válido", "audit02", IllegalArgumentException.class
			}, {
				/*
				 * a) Un auditor puede guardar una auditoria
				 * b) La auditoría debe ser una que tenga asignada el auditor logueado
				 * c) 100%
				 * d) 9/9
				 */
				"auditor0", true, 7, this.format.parse("2019/01/01 11:00:00"), "Texto válido", "audit03", IllegalArgumentException.class
			}
		};
		...
		final Object testingData[][] = {
			{
				...
				/*
				 * a) Un auditor puede borrar una auditoria
				 * b) No se puede borrar una auditoría en modo final
				 * c) 100%
				 * d)
				 */
				...
				/*
				 * a) Un auditor puede borrar una auditoria
				 * b) No se puede borrar una auditoría de otro auditor
				 * c) 100%
				 * d)
				 */
