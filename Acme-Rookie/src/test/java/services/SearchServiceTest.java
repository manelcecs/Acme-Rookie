...
public class SearchServiceTest extends AbstractTest {
	...
	public void searchDriver() {
		...
		position1.add(this.positionService.findOne(this.getEntityId("position10")));
		position2.add(this.positionService.findOne(this.getEntityId("position25")));
		position2.add(this.positionService.findOne(this.getEntityId("position26")));
		...
		final Object testingData[][] = {
			{
				 ...
				 * 
				 */
				this.rookieService.findAll().iterator().next().getUserAccount().getUsername(), "Drive", position1, null
			}, {
				/**
				 * a) 7.4: search positions by keyword
				 * b) Positive
				 ...
				 * 
				 */
				this.companyService.findAll().iterator().next().getUserAccount().getUsername(), "Reparacion de servidores.", position2, null
			}, {
				/**
				 * a) 7.4: search positions by keyword
				 * b) Positive
