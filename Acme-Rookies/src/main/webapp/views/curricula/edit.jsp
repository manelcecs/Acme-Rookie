...
<form:form modelAttribute="curriculaAndPersonalDataForm" action="curricula/rookie/save.do" method="post">
	...
	<acme:cancel url="/curricula/rookie/list.do" code="curricula.edit.cancel" />
