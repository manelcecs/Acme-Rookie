...
<form:form modelAttribute="positionData" action="positionData/rookie/save.do">
	<acme:hidden path="id"/>
	...
	<acme:cancel url="/curricula/rookie/display.do?curriculaId=${positionData.curricula.id}" code="positionData.edit.cancel" />
</form:form>