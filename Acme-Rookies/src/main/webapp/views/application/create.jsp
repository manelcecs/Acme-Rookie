...
<acme:button code="application.create.cancel" type="button" url="application/rookie/list.do"/>

<form:form modelAttribute="applicationForm" action="application/rookie/save.do" method="post">
