...
public class MessageServiceTest extends AbstractTest {
		...
		final Object testingData[][] = {
			{
				 ...
				 * 
				 */
				"rookie0", "rookie0", "rookie1", "body", "subject", "tag", "HIGH", null
			}, {
				/**
				 ...
				 * 
				 */
				"rookie0", "rookie0", "rookie1", "", "subject", "tag", "HIGH", ConstraintViolationException.class
			}, {
				/**
				 ...
				 * 
				 */
				"rookie0", "rookie0", "rookie1", "body", "", "tag", "HIGH", ConstraintViolationException.class
			}, {
				/**
				 ...
				 * 
				 */
				"rookie0", "rookie0", "rookie1", "body", "subject", "tag", "", ConstraintViolationException.class
			}, {
				/**
				 ...
				 * 
				 */
				"rookie0", "rookie0", "rookie1", "body", "subject", "tag", "No priority", ConstraintViolationException.class
			}, {
				/**
				 ...
				 * 
				 */
				"rookie0", "company0", "rookie1", "body", "subject", "tag", "No priority", IllegalArgumentException.class
			}
		};
		...
		final Object testingData[][] = {
			{
				 ...
				 * 
				 */
				"rookie1", "rookie0", "rookie1", null
			}, {
				/**
				 * a) #2 | An company delete a message that is not yours
				 * b) Negative
				 * c) Sequence coverage: 7%
				 * d) Data coverage: 100%
				 * 
				 */
				"company0", "rookie0", "rookie1", IllegalArgumentException.class
			}, {
				/**
				 ...
				 * 
				 */
				"admin", "rookie0", "rookie1", IllegalArgumentException.class
			}, {
				/**
				 * a) #2 | An rookie delete a message that is not yours
				 * b) Negative
				 * c) Sequence coverage: 7%
				 * d) Data coverage: 100%
				 * 
				 */
				"rookie2", "rookie0", "rookie1", IllegalArgumentException.class
			}, {
				/**
				 ...
				 * 
				 */
				null, "rookie0", "rookie1", IllegalArgumentException.class
			}
		};
	 ...
	 * b)Positive
	 * c)Sequence coverage: 23/23
	 * d)Data coverage: 100%
	 */
	@Test
	public void spamMessage() throws ParseException {
		super.authenticate("rookie0");

		final int idSender = this.getEntityId("rookie0");
		final int idRecipient = this.getEntityId("rookie1");
