...
public class MessageBoxServiceTest extends AbstractTest {
		...
		final Object testingData[][] = {
			{
				 ...
				 * 
				 */
				"rookie0", "In Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #1 | An actor create a message box with unlegal name
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "Out Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #1 | An actor create a message box with unlegal name
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "Notification Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #1 | An actor create a message box with unlegal name
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "Spam Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #1 | An actor create a message box with unlegal name
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "Trash Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #1 | An actor create a message box with unlegal name
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "", ConstraintViolationException.class
			}
		};
		...
		final Object testingData[][] = {
			{
				...
				/**
				 * a) #2 | An company edit a original message box
				 * b) Negative
				 * c) Sequence coverage: 84'2%
				 * d) Data coverage: -
				 * 
		...
		final Object testingData[][] = {
			{
				 ...
				 * 
				 */
				"rookie0", "rookie0", "In Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #3 | An Actor delete his box
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "rookie0", "Out Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #3 | An Actor delete his box
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "rookie0", "Trash Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #3 | An Actor delete his box
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "rookie0", "Notification Box", IllegalArgumentException.class
			}, {
				/**
				 ...
				 * 
				 */
				"rookie0", "rookie0", "Spam Box", IllegalArgumentException.class
			}, {
				/**
				 ...
				 * 
				 */
				"rookie0", "admin", "In Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #3 | An Actor delete someone else's box
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "admin", "Out Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #3 | An Actor delete someone else's box
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "admin", "Trash Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #3 | An Actor delete his In box
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "admin", "Notification Box", IllegalArgumentException.class
			}, {
				/**
				 * a) #3 | An Actor delete someone else's box
				 * b) Negative
				 ...
				 * 
				 */
				"rookie0", "admin", "Spam Box", IllegalArgumentException.class
			}
		};
	...
	public void deleteMessageBox() {
		...
		final int idActor = this.getEntityId("rookie0");

		final MessageBox messageBox = this.messageBoxService.create();

		messageBox.setDeleteable(true);
		messageBox.setName("Nombre válido");
